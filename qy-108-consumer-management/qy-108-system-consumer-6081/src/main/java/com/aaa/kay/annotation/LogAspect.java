...
import com.aaa.kay.utils.IPUtils;
...
public class LogAspect {
     ...
     * @Date: 2020/5/28
    **/
    @Pointcut("@annotation(com.aaa.kay.annotation.LoginLogAnnotation)")
    ...
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws ClassNotFoundException {
        ...
        ResultData resultData = iqyService.addLoginLog(map);
