...
import com.aaa.kay.properties.DBProperties;
import com.aaa.kay.properties.PropertiesUtils;
import com.aaa.kay.utils.StringUtils;
...
*/
/**
 * @ClassName DymamicDataSourceRegister
 * @Description: 把整个数据源的操作 开启事物 设置数据源 连接数据库 加载青葱 托管给spring处理
 * @Author 59983
 * @Date 2020/6/1
 * @Version V1.0
 **//*
